...
//configure pages and their controllers
app.config([
  '$stateProvider',
  '$urlRouterProvider',
...
//controls changes to products, and requests for information about products and other users
...
//handles requests and changes to the logged in user
